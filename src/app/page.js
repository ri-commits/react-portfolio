...
const portfolioImg = [web1, web2, web3, web4, web5, web6];
        ...
        <section className=" min-h-screen">
          ...
          <div className="text-center p-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 md:text-xl max-w-xl mx-auto dark:text-gray-200">
              ...
              your project? Look no further! I'm a skilled freelance developer
              and designer, ready to bring your vision to life. Join me on this
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              Since the beginning of my journey as freelancer developer, I've
